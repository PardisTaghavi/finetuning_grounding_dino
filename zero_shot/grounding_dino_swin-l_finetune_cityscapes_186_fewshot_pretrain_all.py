...
coco_od_dataset = dict(
    ...
    return_classes=True,
    type='ODVGDataset')
data_root = '/workspace/datasets/train_merge_/'
...
launcher = 'pytorch'
load_from = '/workspace/models/grounding_dino_swin-l_pretrain_all-56d69e78.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file=
    '/workspace/datasets/train_merge_/annotations/instancesonly_filtered_gtFine_val.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
train_cfg = dict(max_iters=10000, type='IterBasedTrainLoop', val_interval=2500)
...
work_dir = './work_dirs/grounding_dino_swin-l_finetune_cityscapes_186_fewshot_pretrain_all'
