...
coco2014_vg_dataset = dict(
    ...
    pipeline=[
        ...
        dict(
            ...
            tokenizer_name=
            '/scratch/user/ptgh/KD/util/mmdetection/bert-base-uncased',
...
coco_od_dataset = dict(
    ...
    return_classes=True,
    type='ODVGDataset')
data_root = '/scratch/user/ptgh/datasets/cityscapes/cityscapes_few_shot/'
dataset_type = 'ODVGDataset'
default_hooks = dict(
    checkpoint=dict(
        by_epoch=False, interval=500, max_keep_ckpts=30,
        type='CheckpointHook'),
...
lang_model_name = '/scratch/user/ptgh/KD/util/mmdetection/bert-base-uncased'
launcher = 'pytorch'
load_from = '/scratch/user/ptgh/KD/util/mmdetection/weights/grounding_dino_swin-l_pretrain_all-56d69e78.pth'
log_level = 'INFO'
...
model = dict(
    ...
    language_model=dict(
        ...
        max_tokens=256,
        name='/scratch/user/ptgh/KD/util/mmdetection/bert-base-uncased',
        pad_to_max=False,
        special_tokens_list=[
            '[CLS]',
            '[SEP]',
...
optim_wrapper = dict(
    ...
    optimizer=dict(lr=1e-05, type='AdamW', weight_decay=0.01),
    paramwise_cfg=dict(
        custom_keys=dict(
...
test_evaluator = dict(
    ann_file=
    '/scratch/user/ptgh/datasets/cityscapes/cityscapes_few_shot/annotations/instancesonly_filtered_gtFine_val.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=dict(
            ...
            data_root=
            '/scratch/user/ptgh/datasets/cityscapes/cityscapes_few_shot/',
